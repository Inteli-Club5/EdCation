...
contract Musica is ERC721URIStorage, Ownable {
    ...
    constructor(address initialOwner) ERC721("Musica EdCation3", "MEC") Ownable(msg.sender) {}
    ...
    function mint(address to) external onlyOwner {
        ...
        _setTokenURI(tokenId, "bafybeicb4pmlpuf7vdmx3xekxvsna7vc6vltzettqa4ivu4vd2cbkuymqm");
    }
}
